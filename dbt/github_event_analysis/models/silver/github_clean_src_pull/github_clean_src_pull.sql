...
SELECT 
    ...
    JSON_UNQUOTE(JSON_EXTRACT(raw_payload, '$.merged_at'))          as merged_at,
    ...
    JSON_UNQUOTE(JSON_EXTRACT(raw_payload, '$.closed_at'))          as closed_at,
    JSON_UNQUOTE(JSON_EXTRACT(raw_payload, '$.closed_by'))          as closed_by,
    JSON_UNQUOTE(JSON_EXTRACT(raw_payload, '$.created_at'))         as created_at,
    JSON_UNQUOTE(JSON_EXTRACT(raw_payload, '$.updated_at'))         as updated_at,
